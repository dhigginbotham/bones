...
function custom_posts_loop() {
	...
	$post_types = array('customType','anotherCustomType'); //just add more types to this array, ie this example
	...
	*/
    ...
    register_taxonomy( 'custom_cat', 
    	array('customType'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
